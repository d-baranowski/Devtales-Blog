...
const isDev = argv.dev !== undefined;
...
const renderReact = (entryFile, outputFile, standalone, ignore) =>{
    ...
    return bundler.bundle() //Grab our bundle
        ...
        .pipe(isDev ? sourcemaps.init({ loadMaps: true }) : gutil.noop()) //Initialise sourcemaps.
        .pipe(!isDev ? streamify(uglify()) : gutil.noop()) //Minify and uglify the code.
