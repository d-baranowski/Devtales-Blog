...
import static net.devtales.blog.api.service.VideoUtils.getBufferedImageFromVideo;
...
public class FileStorageService {
    ...
    public String store(MultipartFile file) {
        ...
        try {
            ...
            boolean fileSuccessfullyCreated = serverFile.createNewFile();
    ...
    private BufferedImage scaleImage(BufferedImage img) {
        ...
        int scaleX = Double.valueOf(img.getWidth() * (1.0 / times)).intValue();
        int scaleY = Double.valueOf(img.getHeight() * (1.0 / times)).intValue();
